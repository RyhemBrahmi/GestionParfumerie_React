...
class CreateHairCare extends Component {
    constructor(props){
        super(props)
        this.state = {
           nomProduit:'',
        ...
        this.saveHairCare = this.saveHairCare.bind(this);
    ...
    saveHairCare = (e) => {
        ...
        HairCareService.createHairCare(hairCare).then(res => {
            ...
            <div className="droit">
                   ...
                   <div className ="row">
                    <div className="card col-md-6 offset-md-3 offset-md-3" style= {{ marginTop: "15px" }} >
                        <h3 className="text-center">Ajouter Soin des cheveux </h3>
                        <div className = "card-body">
                            <form>
                                ...
                                <label>Image</label>
                                    ...
                                    <br></br>
                                    <img src={this.state.baseImage} height="80px"/>
