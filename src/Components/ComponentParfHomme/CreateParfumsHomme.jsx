...
class CreateParfumsHomme extends Component {
    constructor(props){
        super(props)
        this.state = {
           nomProduit:'',
    ...
    saveParfums = (e) => {
        ...
        ParfumsHommeService.createParfumsHomme(parfumsHomme).then(res => {
...
export default CreateParfumsHomme;