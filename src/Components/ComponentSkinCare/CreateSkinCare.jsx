...
class CreateSkinCare extends Component {
    constructor(props){
        super(props)
        this.state = {
           nomProduit:'',
        ...
        this.saveSkinCare = this.saveSkinCare.bind(this);
    ...
    saveSkinCare = (e) => {
        ...
        SkinCareService.createSkinCare(skincare).then(res => {
            ...
            <div className="droit">
                   ...
                   <div className ="row">
                    <div className="card col-md-6 offset-md-3 offset-md-3" style= {{ marginTop: "15px" }} >
                        <h3 className="text-center">Ajouter Soin de la peau </h3>
